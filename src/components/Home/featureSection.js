      ...
      <Fade bottom cascade>
        <div className="w-full flex flex-row justify-between mt-10 xxs:flex-col xs:flex-col sm:flex-row">
          <div className="rounded-xl w-full h-52 flex flex-col content-center justify-center align-middle text-center m-5 bg-gradient-to-r from-lightblack to-lightblack hover:from-purple hover:to-pink transition duration-500 ease-in-out">
            <h1 className="text-white text-2xl">Web Application Pentest</h1>

          </div>
          <div className="rounded-xl w-full h-52 flex flex-col content-center justify-center align-middle text-center m-5 bg-gradient-to-r from-lightblack to-lightblack hover:from-purple hover:to-pink transition duration-500 ease-in-out">
            <h1 className="text-white text-2xl">Managed Vulnerability Scanning</h1>
          
          </div>
          <div className="rounded-xl w-full h-52 flex flex-col content-center justify-center align-middle text-center m-5 bg-gradient-to-r from-lightblack to-lightblack hover:from-purple hover:to-pink transition duration-500 ease-in-out">
            <h1 className="text-white text-2xl">Network Pentest</h1>

          </div>
          <div className="rounded-xl w-full h-52 flex flex-col content-center justify-center align-middle text-center m-5 bg-gradient-to-r from-lightblack to-lightblack hover:from-purple hover:to-pink transition duration-500 ease-in-out">
            <h1 className="text-white text-2xl"> Wireless Pentest</h1>
      ...
      <Fade bottom cascade>
        <div className="mt-10 px-8">
          <h1 className="text-white text-7xl font-bold xxs:text-2xl xs:text-2xl sm:text-3xl lg:text-5xl xl:text-7xl">
            Why Hawkeye Security?
          </h1>
          <h2 className="text-white text-sm mt-5 opacity-50">
          We blend unparalleled expertise with a commitment to your security.<br></br> 
          <br></br>
          Our team of certified professionals utilizes the latest methodologies to provide comprehensive, 
          tailored solutions that protect your business from evolving threats. 
          Trust us to be your partners in building a resilient and secure digital future.
          ...
          <div className="w-2/6 bg-gradient-to-r from-pink to-purple p-8 rounded-xl m-5 xxs:w-full xs:w-full sm:w-2/6">
            ...
            <div className="mt-5">
              <div>
                ...
                <h1 className="text-white text-sm">2024</h1>
              </div>
              <div className="mt-5">
